...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, PageOne, PageTwo, B_I, BIS , NEW , P_F, R_M, R_F,SEC, G_S, G_P_P, G_P_T,LU_G_S,LU_P_P,CRO,DOO,CHO,G_SE,JA,SO,VA,N_M,LA,T_L,T_C,T_CU):
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label =tk.Label(self,text="*En esta herramienta va a encontrar dos opciones para resolver sistemas de ecuaciones,",fg="gray25", font=("Comic Seans MS",15),width="80",height="2",bg="light sea green")
        label.pack()

        label =tk.Label(self,text="puede ser por medio de metodos numericos o por medio de metodos matriciales:*",fg="gray25", font=("Comic Seans MS",15),width="80",height="2",bg="light sea green")
        label.pack()
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Gauss Simple",
                            command=lambda: controller.show_frame("G_S"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button2 = tk.Button(self, text="Gauss Pivoteo Parcial",
                            command=lambda: controller.show_frame("G_P_P"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button3 = tk.Button(self, text="Gauss Pivoteo Total",
                            command=lambda: controller.show_frame("G_P_T"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")
        
        button4 = tk.Button(self, text="LU Gauss Simple",
                            command=lambda: controller.show_frame("LU_G_S"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button5 = tk.Button(self, text="LU Pivoteo Parcial",
                            command=lambda: controller.show_frame("LU_P_P"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button6 = tk.Button(self, text="Crout",
                            command=lambda: controller.show_frame("CRO"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button7 = tk.Button(self, text="Doolittle",
                            command=lambda: controller.show_frame("DOO"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button8 = tk.Button(self, text="Cholesky",
                            command=lambda: controller.show_frame("CHO"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")
        
        button9 = tk.Button(self, text="Gauss Seidel",
                            command=lambda: controller.show_frame("G_SE"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button10 = tk.Button(self, text="Jacobi",
                            command=lambda: controller.show_frame("JA"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")
        
        button11 = tk.Button(self, text="Sor",
                            command=lambda: controller.show_frame("SO"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button12 = tk.Button(self, text="Vandermonde",
                            command=lambda: controller.show_frame("VA"),width="100",height="1",bg="gray25",fg="cyan2")

        button13 = tk.Button(self, text="Newton",
                            command=lambda: controller.show_frame("N_M"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button14 = tk.Button(self, text="Lagrange",
                            command=lambda: controller.show_frame("LA"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button15 = tk.Button(self, text="Trazadores Lineales",
                            command=lambda: controller.show_frame("T_L"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button16 = tk.Button(self, text="Trazadores Cuadraticos",
                            command=lambda: controller.show_frame("T_C"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")

        button17 = tk.Button(self, text="Trazadores Cubicos",
                            command=lambda: controller.show_frame("T_CU"),width="100",height="1",bg="gray25",fg="cyan2",activebackground="#F50743")
